        ...
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid md:grid-cols-2 gap-8 items-start">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Use attributes like <code>php-foreach</code> and <code>php-if</code> directly in your HTML.</p>
                    <div class="mt-4">
...
&lt;/ul&gt;</code></pre>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">For greater clarity, use the <code>&lt;template&gt;</code> tag, which will not be included in the final render.</p>
                    <div class="mt-4">
                        <pre><code class="language-html">&lt;ul&gt;
...
&lt;/ul&gt;</code></pre>
    ...
    <div class="bg-gray-50">
        <div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <h2 id="installation--usage" class="text-3xl font-extrabold text-gray-700 text-center">Installation & Usage</h2>
            <div class="mt-8">
                <p class="text-lg text-gray-600">
                    <strong>PHP ^8.4</strong> is required. Pesto is available via Composer and has <strong>no third-party dependencies.</strong>
                </p>
            </div>
            <div class="mt-8">
    ...
    <div class="bg-white">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12">
                ...
                <p class="mt-2 text-gray-600">The <code>&lt;template&gt;</code> tag allows you to define <code>php-*</code> attributes that will be evaluated, but the tag itself will not be included in the final render.</p>
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <p class="font-medium text-gray-800">Input</p>
                        <pre class="mt-2"><code class="language-html">&lt;p php-if="$user->isAdmin()"&gt;Admin&lt;/p&gt;</code></pre>
            ...
            <div id="partials--slots" class="mt-12">
                ...
                <p class="mt-2 text-gray-600">When working with views composed of other views, you can use partials and slots to avoid repetition.</p>
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
...
&lt;/template&gt;</code></pre>
            ...
            <div id="nested-views" class="mt-12">
                ...
                <p class="mt-2 text-gray-600">Pesto allows you to nest views, reusing the same layout multiple times in the same view.</p>
                <div class="mt-4">
...
&lt;/template&gt;</code></pre>
    ...
    <div class="bg-gray-50">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-center mt-4 text-lg text-gray-600">Pesto provides <strong>foreach</strong> and <strong>if</strong> directives, sufficient for building any view.</p>

            <div class="mt-12 grid md:grid-cols-2 gap-8">
                <div>
                    <h3 class="text-xl text-gray-800 font-bold">If Attribute</h3>
                    <p class="mt-2 text-gray-600">Conditionally render blocks. <code>php-elseif</code> and <code>php-else</code> must be siblings of <code>php-if</code>.</p>
...
&lt;p php-else&gt;Guest&lt;/p&gt;</code></pre>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">We can use to render a list of items based on an array or iterable objects.</p>
...
&lt;/ul&gt;</code></pre>
    ...
    <div class="bg-white">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-center mt-4 text-lg text-gray-600">Apply transformations to variables using the pipe <code>|</code> operator. You can also create your own.</p>
            ...
            <div class="mt-12 grid md:grid-cols-2 gap-x-8 gap-y-12">
                ...
                <div>
                    ...
                    <pre class="mt-4"><code class="language-html">&lt;p&gt;@{{ $createAt | date:'m-d-Y' }}&lt;/p&gt;</code></pre>
                </div>
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-gray-800">
                        ...
                        <li><strong>String</strong>: upper, lower, capitalize, title, trim, nl2br, strip_tags, slug, join.</li>
                    </ul>
                </div>
            </div>
