<template php-partial="layout.php">
    <div class="bg-gradient-to-tr from-[#222932] to-emerald-800 text-white">
        ...
        <div class="max-w-7xl mx-auto pb-20 px-2 text-center">
            <img src="/img/cake.svg" alt="CakePHP Logo" class="w-24 h-24 mx-auto mb-4">
            ...
            <p class="text-lg text-white p-4 max-w-4xl mx-auto text-center">
                Integrate the Pesto template engine into your CakePHP projects to create expressive and modern
                views.
            </p>
        </div>
    </div>
    ...
    <div class="bg-white">
        <div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12">
                <h3 class="text-2xl text-gray-800 font-bold">2. Create a Pesto View Class</h3>
                <p class="mt-2 text-gray-600">
                    Create a custom View class at <code>src/View/PestoView.php</code> that extends CakePHP's View.
                </p>
                <div class="mt-4">
...
class PestoView extends View
{
    ...
    protected function _render(string $templateFile, array $data = []): string
    {
        ...
        return $this->pesto->make($relative, array_merge(
            ...
            <div class="mt-12">
                <h3 class="text-2xl text-gray-800 font-bold">3. Set PestoView in Your Controller</h3>
                <p class="mt-2 text-gray-600">
    ...
    public function initialize(): void
    {
        ...
        $this->viewBuilder()->setClassName('Pesto');
            ...
            <div class="mt-12">
                ...
                <p class="mt-2 text-gray-600">
                    Use the standard CakePHP <code>set()</code> method to pass data to your Pesto templates.
                </p>
                <div class="mt-4">
                    <pre><code class="language-php">namespace App\Controller;
    ...
    public function index()
    {
        ...
        $this->set(compact('articles'));
            ...
            <div class="mt-12">
                ...
                <p class="mt-2 text-gray-600">
                    Create your template at <code>templates/Articles/index.php</code>. You can now use Pesto's syntax.
                </p>
                <div class="mt-4">
