<template php-partial="layout.php">
    <div class="bg-gradient-to-tr from-[#222932] to-emerald-800 text-white">
        ...
        <div class="max-w-7xl mx-auto pb-20 px-2 text-center">
            <img src="/img/symfony.svg" alt="Symfony Logo" class="w-24 h-24 mx-auto mb-4">
            ...
            <p class="text-lg text-white p-4 max-w-4xl mx-auto text-center">
                Integrate the Pesto template engine into your Symfony projects to create expressive and modern
                views.
            </p>
        </div>
    </div>
    ...
    <div class="bg-white">
        <div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12">
                <h3 class="text-2xl text-gray-800 font-bold">2. Register Pesto as a Service</h3>
                <p class="mt-2 text-gray-600">
                    Add the Pesto factory to your <code>config/services.yaml</code>.
                </p>
                <div class="mt-4">
    ...
    pesto.view:
        ...
        arguments:
            ...
            <div class="mt-12">
                <h3 class="text-2xl text-gray-800 font-bold">3. Create a Helper Controller Trait</h3>
                <p class="mt-2 text-gray-600">
                    Create a trait at <code>src/Controller/PestoTrait.php</code> to simplify rendering in your controllers.
                </p>
                <div class="mt-4">
    ...
    public function index(): Response
    {
        return $this->pestoRender('home.php', [
            ...
            <div class="mt-12">
                ...
                <p class="mt-2 text-gray-600">
                    Create your template at <code>templates/home.php</code>. You can now use Pesto's syntax.
                </p>
                <div class="mt-4">
